	...
	for (int k=1;k<=n;k++)
	{
		...
		for (;;t++)
		{
			if (flag1==1)
			{
				...
				{
					case 0:
						cout<<"It has a "<<weapon[(t+1)%3]<<",and it's morale is ";
						printf("%.2lf\n",1.0*lifeRed/life[0]);
						break;
					case 1:
						cout<<"It has a "<<weapon[(t+1)%3]<<" and a "<<weapon[(t+2)%3]<<endl;
						break;
					case 2:
						cout<<"It has a "<<weapon[(t+1)%3]<<endl;
						break;
					case 3:
						cout<<"It's loyalty is "<<lifeRed<<endl;
						break;
				}
				i+=1;
				i%=5;
			...
			if (flag2==1)
			{
				...
				switch (orderBlue[j])
				{
					...
					case 2:
						...
						break;
					case 3:
						cout<<"It's loyalty is "<<lifeBlue<<endl;
						break;
				}
				j+=1;
				j%=5;
